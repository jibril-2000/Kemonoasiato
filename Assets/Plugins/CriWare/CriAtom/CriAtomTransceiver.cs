 ...
 * <remarks>
 * <para header='説明'>
 * 空間音響接続機能を提供するコンポーネントです。3Dポジショニングが有効な音声をサブミックスして、一点から出力します。<br/>
...
public class CriAtomTransceiver : CriMonoBehaviour
{
	...
	[SerializeField] private string inputAzimuthAisacControlId = string.Empty;
	[SerializeField] private string inputElevationAisacControlId = string.Empty;
	...
	private void ApplyParameters()
	{
		...
		TrySetAisacControlId(inputAzimuthAisacControlId, this.transceiverHn.SetListenerBasedAzimuthAngleAisacControlId);
		TrySetAisacControlId(inputElevationAisacControlId, this.transceiverHn.SetListenerBasedElevationAngleAisacControlId);
	...
	public void OnDrawGizmos()
	{
		...
		Gizmos.DrawIcon(this.transform.position, "Criware/Transceiver.png");
