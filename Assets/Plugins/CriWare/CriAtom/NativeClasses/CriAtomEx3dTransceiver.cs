...
public class CriAtomEx3dTransceiver : CriDisposable
{
	 ...
	 * <remarks>
	 * <para header='説明'>
	 * 3Dトランシーバーに設定されているパラメータを使用して、3Dトランシーバーを更新します。<br/>
	 ...
	 * </para>
	 * <para header='注意'>
	 * 設定したパラメータを実際に適用するには、 ::CriAtomEx3dTransceiver::Update 関数を呼び出す必要があります。
	 * </para>
	 * </remarks>
	 ...
	 * <remarks>
	 * <para header='説明'>
	 * 3Dトランシーバー出力のサウンドコーンパラメータを設定します。<br/>
	 ...
	 * <remarks>
	 * <para header='説明'>
	 * 3Dトランシーバー出力の最小距離／最大距離を設定します。<br/>
	 ...
	 * AISACのデタッチに失敗した理由については、エラーメッセージを確認してください。<br/>
	 * </para>
	 * </remarks>
	 ...
	 * </para>
	 * <para header='注意'>
	 * 設定したパラメータを実際に適用するには、::CriAtomEx3dTransceiver::Update 関数を呼び出す必要があります。<br/>
	 * </para>
	 * </remarks>
	 * <seealso cref='CriAtomEx3dTransceiver::Update'/>
	 */
