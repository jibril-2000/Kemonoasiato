...
public class CriAtomExMic : CriDisposable
{
	 ...
	 * <remarks>
	 * <para header='説明'>
	 * オーディオ入力デバイスの状態をチェックして使用可能かどうかを取得します。<br/>
	 * </para>
	 * </remarks>
	 */
	 ...
	 * </para>
	 * <para header='注意'>
	 * 本関数はチャンネル数1を指定して ::CriAtomExMic::Start を呼び出した場合にのみ
	 * 有効です。<br/>
	 * その他の場合はアサート失敗します。
	 * </para>
	 * </remarks>
	 ...
	 * </para>
	 * <para header='注意'>
	 * 本関数はチャンネル数2を指定して ::CriAtomExMic::Start を呼び出した場合にのみ
	 * 有効です。<br/>
	 * その他の場合はアサート失敗します。<br/>
	 ...
	 * </para>
	 * <para header='注意'>
	 * 本関数に渡すデータバッファ配列の配列長は、 ::CriAtomExMic::Start に渡した
	 * ::Config のチャンネル数以上である必要があります。<br/>
	 * その他の場合はアサート失敗します。<br/>
	 * また、各データバッファはすべて numToRead 以上の配列長となるようにしてください。
	 * </para>
	 * </remarks>
