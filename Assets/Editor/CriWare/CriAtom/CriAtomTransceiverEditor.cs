...
public class CriAtomTransceiverEditor : UnityEditor.Editor {
	...
	private SerializedProperty m_inputAzimuthAisacControlId;
	private SerializedProperty m_inputElevationAisacControlId;
	...
	static private readonly GUIContent cInputAzimuthAisacLabel = new GUIContent("Input Azimuth Angle");
	static private readonly GUIContent cInputElevationAisacLabel = new GUIContent("Input Elevation Angle");
	...
	private void OnEnable() {
		...
		m_inputAzimuthAisacControlId = serializedObject.FindProperty("inputAzimuthAisacControlId");
		m_inputElevationAisacControlId = serializedObject.FindProperty("inputElevationAisacControlId");
	...
	public override void OnInspectorGUI() {
		...
		if (targetObj.inspectorAisacSettingFoldout = EditorGUILayout.Foldout(targetObj.inspectorAisacSettingFoldout, "AISAC")) {
			...
			EditorGUILayout.PropertyField(m_inputAzimuthAisacControlId, cInputAzimuthAisacLabel);
			EditorGUILayout.PropertyField(m_inputElevationAisacControlId, cInputElevationAisacLabel);
